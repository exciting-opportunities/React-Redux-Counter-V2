...
import * as actions from '../aactions';


const Counter = ({counter,plus,minus,refresh})=>{
    return(
        <div className='content'>
            ...
            <div className='btn-block'>
                <button className='btn btn-inc' onClick={plus}>
                ...
                <button className='btn btn-dec' onClick={minus}>
                ...
                <button className='btn btn-res' onClick={refresh}>
